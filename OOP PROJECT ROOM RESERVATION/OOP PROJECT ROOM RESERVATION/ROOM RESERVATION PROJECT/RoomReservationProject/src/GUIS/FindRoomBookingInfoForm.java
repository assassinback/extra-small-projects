 ...
 * @author Dell
 */import Classess.*;
public class FindRoomBookingInfoForm extends javax.swing.JFrame {

    /**
     * Creates new form Homepage
     */
    public FindRoomBookingInfoForm() {
        initComponents();
    }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        FindBooking f=new FindBooking(Integer.parseInt(Txtid.getText()),findtable);
...
// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FindRoomBookingInfoForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FindRoomBookingInfoForm().setVisible(true);
            }
        });
    }
