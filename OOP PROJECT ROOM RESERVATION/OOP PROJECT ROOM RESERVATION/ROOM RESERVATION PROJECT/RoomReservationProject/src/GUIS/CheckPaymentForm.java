...
public class CheckPaymentForm extends javax.swing.JFrame {
  ...
  Statement stmt=null;
    ...
    private void initComponents() {
        ...
        jPanel5.add(jPanel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 330, -1, -1));
        ...
        jPanel5.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 280, 140, -1));
        ...
        jPanel5.add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 280, -1, -1));
...
try{
            ...
            conn=  setConnection();
        String query="Select Name,AccountNo,SecurityCode,PaymentType,Clearence,Feedback from Payment";
...
setVisible(false);// TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CheckPaymentForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CheckPaymentForm().setVisible(true);
            }
        });
    }
