 ...
 */
import Classess.*;
public class DeleteMemberInfoForm extends javax.swing.JFrame {

    /**
     * Creates new form Homepage
     */
    public DeleteMemberInfoForm() {
        initComponents();
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        Deletedata x=new Deletedata(Integer.parseInt(txtID.getText()));
...
setVisible(false);        // TODO add your handling code here:
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteMemberInfoForm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteMemberInfoForm().setVisible(true);
            }
        });
    }
